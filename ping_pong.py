...
back = transform.scale(image.load("footballplace.png"), (win_width, win_height))
...
racket1 = Player('footballperson1.png', 30, 200, 4, 50, 150) 
racket2 = Player('footballperson2.png', 520, 200, 4, 50, 150)
ball = GameSprite('footballball.png', 200, 200, 4, 50, 50)
